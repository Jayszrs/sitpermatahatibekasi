...
<?php endif; ?>
<?php elseif($page==='contact'): $unitCampus=school_unit_catalog()[UNIT_SLUG]??[]; $unitMapEmbed=openstreetmap_embed_url((string)($unitCampus['latitude']??''),(string)($unitCampus['longitude']??'')); ?><section class="section"><div class="shell contact-grid"><div><span class="eyebrow">KONTAK ADMINISTRASI</span><h2><?php echo unit_e($settings['name']); ?></h2><dl><dt>Alamat</dt><dd><?php echo nl2br(unit_e($settings['address'])); ?></dd><dt>Telepon</dt><dd><a href="tel:<?php echo unit_e(preg_replace('/[^0-9+]/','',$settings['phone'])); ?>"><?php echo unit_e($settings['phone']); ?></a></dd><dt>Email</dt><dd><a href="mailto:<?php echo unit_e($settings['email']); ?>"><?php echo unit_e($settings['email']); ?></a></dd></dl><div class="social-links"><a href="<?php echo unit_e($settings['instagram']); ?>" target="_blank" rel="noopener">Instagram</a><a href="<?php echo unit_e($settings['youtube']); ?>" target="_blank" rel="noopener">YouTube</a></div></div><div class="map-card"><iframe title="Peta <?php echo unit_e($settings['name']); ?>" src="<?php echo unit_e($unitMapEmbed); ?>" loading="lazy"></iframe><a class="button button-primary" href="<?php echo unit_e($settings['maps']); ?>" target="_blank" rel="noopener">Buka Petunjuk Arah</a></div></div></section>
