...
function unit_page_start(string $title, string $active = 'home'): void {
    ...
    ?>
<!doctype html><html lang="id"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?php echo unit_e($title . ' - ' . $settings['name']); ?></title><meta name="description" content="<?php echo unit_e($settings['description']); ?>"><link rel="icon" type="image/webp" href="<?php echo unit_asset('assets/images/logo.png'); ?>"><link rel="stylesheet" href="<?php echo unit_asset('assets/css/style.css'); ?>"><link rel="stylesheet" href="<?php echo unit_asset('assets/css/foundation-refresh.css'); ?>"><link rel="stylesheet" href="<?php echo unit_e('../frontend/assets/css/unit-public-features.css?v=' . (@filemtime(__DIR__ . '/../frontend/assets/css/unit-public-features.css') ?: 1)); ?>"><style>:root{--primary:<?php echo unit_e($theme['primary']); ?>;--primary-dark:<?php echo unit_e($theme['primary_dark']); ?>;--accent:<?php echo unit_e($theme['accent']); ?>;--soft:<?php echo unit_e($theme['soft']); ?>;--ink:<?php echo unit_e($theme['ink']); ?>;--logo-hue:<?php echo unit_e($theme['logo_hue'] ?? '0deg'); ?>}</style></head><body>
