...
$contentTypes = [
    ...
    'activity' => ['label' => 'Kegiatan', 'title' => 'Nama kegiatan', 'subtitle' => 'Unit/kategori', 'extra' => 'Isi artikel lengkap', 'help' => 'Kelola artikel kegiatan internal lengkap dengan ringkasan, isi, dan foto utama. Dokumentasi tambahan dikelola melalui Galeri Unit; Instagram tetap terpisah.'],
];
$type = $_GET['type'] ?? 'unit';
