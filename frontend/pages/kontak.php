                ...
                <article class="campus-card">
                    ...
                    <div class="campus-direct-contact">
                        ...
                        <div class="campus-social-links" aria-label="Media sosial <?php echo esc($campus['subtitle']); ?>">
                            <a class="campus-social-whatsapp" href="https://wa.me/<?php echo esc($whatsapp); ?>?text=<?php echo esc($waMessage); ?>" target="_blank" rel="noopener" aria-label="WhatsApp <?php echo esc($campus['subtitle']); ?>"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21 11.5a8.5 8.5 0 0 1-12.3 7.6L3 21l1.9-5.7A8.5 8.5 0 1 1 21 11.5Z"></path><path d="M9 9c.4 2.5 2 4.1 4.5 4.8l1.2-1.2 2.1.5c.3.1.5.4.5.7v1.5c0 .4-.3.7-.7.7C11.8 17 7 12.2 7 7.4c0-.4.3-.7.7-.7h1.5c.3 0 .6.2.7.5L10.4 9 9 9Z"></path></svg><span>WhatsApp</span></a>
                            ...
                            <?php if(!empty($campus['youtube'])): ?><a href="<?php echo esc($campus['youtube']); ?>" target="_blank" rel="noopener" aria-label="YouTube <?php echo esc($campus['subtitle']); ?>"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M22.5 12s0-3.2-.4-4.7a2.8 2.8 0 0 0-2-2C18.5 5 12 5 12 5s-6.5 0-8.1.3a2.8 2.8 0 0 0-2 2C1.5 8.8 1.5 12 1.5 12s0 3.2.4 4.7a2.8 2.8 0 0 0 2 2C5.5 19 12 19 12 19s6.5 0 8.1-.3a2.8 2.8 0 0 0 2-2c.4-1.5.4-4.7.4-4.7Z"></path><path d="m10 15 5-3-5-3v6Z"></path></svg><span>YouTube</span></a><?php endif; ?>
                        </div>
                    </div>
